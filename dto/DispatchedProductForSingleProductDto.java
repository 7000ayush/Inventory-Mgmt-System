...
@AllArgsConstructor
@Builder
public class DispatchedProductForSingleProductDto {
    ...
    private String productName; // Name of the product (optional, for service logic purposes)
    ...
    private int currentStock; // Current stock of the product
